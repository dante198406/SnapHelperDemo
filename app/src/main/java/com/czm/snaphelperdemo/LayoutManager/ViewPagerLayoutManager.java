package com.czm.snaphelperdemo.LayoutManager;
...
import com.czm.snaphelperdemo.CustomRecycleView;
...
public abstract class ViewPagerLayoutManager extends RecyclerView.LayoutManager {
    ...
    public View findViewByPosition(int position) {
        ...
        //Log.e("====", "=======viewPosition=" + viewPosition);//zhangzhaolei +
    ...
    public void scrollToPosition(int position) {
        ...
        Log.e("====", "=======scrollToPosition=" + position);//zhangzhaolei +
        requestLayout();
    }
    ...
    public int getCurrentPosition() {
        ...
        Log.e("====", "==============getCurrentPosition" + position);
        return position;
    }
